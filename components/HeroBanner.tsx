...
const slides: Slide[] = [
  {
    ...
    subtitle: 'Processed and beautifully packaged in branded jars and containers of every size — from the pantry to bulk.',
    image: 'https://i.pinimg.com/736x/c4/23/bb/c423bba45e40a74fbea478984ee7e3c5.jpg',
    cta: 'Shop Honey',
  ...
  },
  {
    ...
    subtitle: 'Seasonal fruits harvested daily and packed for a brighter, healthier table.',
    image: 'https://i.pinimg.com/736x/ed/10/ca/ed10cad27d2db31706079a09611d4d93.jpg',
    cta: 'Shop Fruits',
  ...
  {
    id: 3,
    title: 'Premium Dorper Sheep & Livestock',
    subtitle: 'Quality breeds raised on natural West Pokot pasture with care, quality, and traceability.',
    image: 'https://i.pinimg.com/736x/c8/12/3d/c8123df84072a0a96675321a408f5176.jpg',
  ...
  },
  {
    ...
    subtitle: 'Healthy birds and eggs from open-pasture farming, raised the natural way.',
    image: 'https://images.unsplash.com/photo-1484557985045-edf25e08da73?w=1200&q=80',
    cta: 'Explore Farm Products',
    ctaLink: '/products',
    bgGradient: 'from-amber-800 via-orange-800 to-amber-900',
  },
];
